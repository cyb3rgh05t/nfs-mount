...
from .routers import nfs, mergerfs, system, notifications
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        mounted = sum(1 for r in nfs_results + mergerfs_results if r["success"])
        failed = sum(1 for r in nfs_results + mergerfs_results if not r["success"])
